...
import com.cart.OnlineShopping.util.FileUploadUtility;
import com.cart.OnlineShopping.validator.ProductValidator;
...
public class ManagementController {
	...
	public String handleProductSubmission(@Valid @ModelAttribute("product") Product mProduct , BindingResult result , Model model , HttpServletRequest request)
	{
		...
		if(result.hasErrors())
		{
			...
			model.addAttribute("message","Validation failed for Ptoduct Submission!");
	...
	{
		//Id going to fetch the product from the database
